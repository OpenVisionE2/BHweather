    ...
    def updateInfo(self):
        ...
        try:
            ...
            if page.find('forecast') > 1:
                ...
                skinwidth = getDesktop(0).size().width()
                if skinwidth == 1280:
                    icon = '/usr/lib/enigma2/python/Plugins/Extensions/BhWeather/weather/%s' % str(Today['Icon'])
                else:
                    icon = '/usr/lib/enigma2/python/Plugins/Extensions/BhWeather/weather/fhd/%s' % str(Today['Icon'])
                ...
                skinwidth = getDesktop(0).size().width()
                if skinwidth == 1280:
                    icon = '/usr/lib/enigma2/python/Plugins/Extensions/BhWeather/weather/small/%s' % str(Week[1]['Icon'])
                else:
                    icon = '/usr/lib/enigma2/python/Plugins/Extensions/BhWeather/weather/fhd/small/%s' % str(Week[1]['Icon'])
                myicon = self.checkIcon(icon)
                png = LoadPixmap(myicon)
                ...
                skinwidth = getDesktop(0).size().width()
                if skinwidth == 1280:
                    icon = '/usr/lib/enigma2/python/Plugins/Extensions/BhWeather/weather/small/%s' % str(Week[2]['Icon'])
                else:
                    icon = '/usr/lib/enigma2/python/Plugins/Extensions/BhWeather/weather/fhd/small/%s' % str(Week[2]['Icon'])
                myicon = self.checkIcon(icon)
                png = LoadPixmap(myicon)
                ...
                myicon = '/usr/lib/enigma2/python/Plugins/Extensions/BhWeather/weather/red.png'
                png = LoadPixmap(myicon)
